...
> **Fork note:** This is the `superpower-claude-plus` fork. The v6.0.x entries below are synced from upstream [obra/superpowers](https://github.com/obra/superpowers); the v5.2.x entries are fork-specific enhancements (orchestrator, skill-router, tool-call logger).
